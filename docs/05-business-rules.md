...
- **4.1 — CHANGED (decision-log #18–#19, 2026-08-24).** Messaging Kit §05 copy is canonical for manifesto, process, who-it's-for, FAQ and final CTA. Edits to canonical copy are owner decisions, logged — and two have now happened, so §05 is **no longer canonical for the hero headline or the Services headline**:
  ...
  - **Services headline** traces to **decision #19** (em-dash removal), not §05 verbatim. The four service *descriptions* remain §05, with the one em dash in the Agentic Systems description replaced by a comma under the same decision.
