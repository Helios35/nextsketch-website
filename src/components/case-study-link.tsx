 ...
 * on Behance" (decision-log #43, #44). The §Interaction-vocabulary gold
...
export function CaseStudyLink({
  ...
  href: string;
  /**
   * Screen-reader-only suffix saying the link opens a new tab: the
   * outward arrow is `aria-hidden` and says nothing to assistive tech,
   * and the footer's Behance link on the same page opens in place.
   */
  hint?: string;
  children: ReactNode;
}) {
