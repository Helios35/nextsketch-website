 ...
 *
 * **Extracted verbatim from `service-page.tsx`** (decision-log #42),
 * where it was inline, so the case study template could end the same
 * way without a third copy of the same thirty lines. Nothing here is
 * new: the markup, the classes, the reveal rhythm (0 / 120ms) and the
 * accent are exactly what the service routes shipped, verified
 * byte-identical in their built HTML before and after the move. The
 * two knobs are `need` and the wrapper class, which were the two
 * things the service page already parameterised in place.
 *
